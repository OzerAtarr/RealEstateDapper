...
namespace RealEstateDapper.API.Repositories.ProductRepository
{
    public interface IProductRepository
    {
        ...
        Task<List<ResultProductWithCategoryDto>> GetProductByDealOfThDayTrueWithCategoryAsync();
        ...
        Task<GetProductDetailByIdDto> GetProductDetailByProductId(int productId);
